...
class _MapSelectionScreenState extends State<MapSelectionScreen> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    setState(() {
      ...
      _selectedLocation = _currentLocation; // Mostrar marcador en la ubicación actual
      _isLoading = false;
    });
  }
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _currentLocation == null
              ? const Center(child: Text('No se pudo obtener la ubicación actual'))
              : FlutterMap(
                  options: MapOptions(
                    ...
                    onTap: (tapPosition, point) {
                      setState(() {
                        _selectedLocation = point; // Cambiar el marcador al punto seleccionado
                      });
                    },
                  ),
                  children: [
