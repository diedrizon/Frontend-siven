...
class _CaptacionState extends State<Captacion> {
  ...
  Future<void> fetchEventosSalud() async {
    try {
      List<Map<String, dynamic>> eventos = await eventoSaludService.listarEventosSalud();
      setState(() {
        eventosSalud = eventos.map((evento) => evento['nombre'] as String).toList();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Campo 1: Evento de Salud (Dropdown Dinámico)
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text(
                ...
                isLoadingEventosSalud
                    ? const Center(child: CircularProgressIndicator())
                    : errorEventosSalud != null
                        ? Text(
                            'Error: $errorEventosSalud',
                            style: const TextStyle(color: Colors.red),
                          )
                        : CustomTextFieldDropdown(
                            hintText: 'Selecciona un evento de salud',
                            controller: eventoSaludController,
                            options: eventosSalud,
          ...
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 5),
              CustomTextFieldDropdown(
                hintText: 'Selecciona una persona',
          ...
          // Campo 4: Semanas de Gestación (Opción)
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text(
              ...
              const SizedBox(height: 5),
              CustomTextFieldDropdown(
                hintText: 'Selecciona las semanas de gestación',
